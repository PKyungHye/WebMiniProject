...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="postUpdateAction.jsp?postno=<%=postno%>">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control"
								placeholder="글 제목" name="ptitle" maxlength="50" required
								value="<%= post.getPtitle() %>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용"
									name="pcontent" maxlength="2048" style="height: 350px;" required><%= post.getPcontent() %></textarea></td>
						</tr>
					</tbody>
				</table>
